        ...
        <div className="absolute inset-0 bg-black/85 flex flex-col justify-center items-center backdrop-blur-sm z-20 animate-fade-in p-4">
          ...
          {onOpenArcadeView && (
            <div className="flex gap-3">
              <button onClick={() => onOpenArcadeView('Awards')} className="bg-gray-800 hover:bg-gray-700 text-white flex-1 py-3 rounded-full font-bold text-xs tracking-widest transition-all">ACHIEVEMENTS</button>
              <button onClick={() => onOpenArcadeView('Shop')} className="bg-gray-800 hover:bg-gray-700 text-white flex-1 py-3 rounded-full font-bold text-xs tracking-widest transition-all">STORE</button>
            </div>
          )}
